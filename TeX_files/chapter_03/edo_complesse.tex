...
\begin{align}
	A = \begin{pmatrix}
		\lambda_1 & 0        \\
		b_{21}    & \lambda_1
	\end{pmatrix} \to \double{U_1 = \lambda_1 u_1 \hfill}{U_2 = b_{21} u_1 + \lambda_1 u_2}
\end{align}
...
\begin{align}
	\frac{U_2}{U_1} = \frac{b_{21} u_1 + \lambda_1 u_2}{\lambda_1 u_1} = \frac{b_{21}}{\lambda_1} + \frac{u_2}{u_1} 
\end{align}
