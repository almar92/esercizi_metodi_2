...
\subsubsubsection{Autovalori di $A$ non coincidenti}
...
\subsubsubsection{Autovalori di $A$ coincidenti}
...
\begin{align}
	...
	&u_2(z) = A u_1(z) \ln(z-z_0) + u_1(z) \sum_{k\in \Z}d_k (z-z_0)^k\nextpassage
	&u_2(z) = A u_1(z) \ln(z-z_0) + (z-z_0)^{\rho_1}\sum_{k\in \Z} c_k (z-z_0)^k \sum_{k\in \Z}d_k (z-z_0)^k\nextpassagecomm{applico il prodotto di Cauchy?}
	&u_2(z) = A u_1(z) \ln(z-z_0) + (z-z_0)^{\rho_1}\sum_{k\in \Z}\sum_{i=0}^{k} c_k d_i (z-z_0)^{k+i}\nextpassage
	&u_2(z) = A \ln(z-z_0) u_1(z) + (z-z_0)^{\rho_1} \sum_{k\in \Z}b_k (z-z_0)^k
\end{align}

\newpage

\subsubsubsection{Punti singolari regolari}
...
\begin{enumerate}
	...
	\begin{align}
		q(z) = - \frac{\ddot{u}(z)}{u(z)} - p(z)\frac{\dot{u}(z)}{u(z)}
	\end{align}
...
\begin{align}
	p(z) &= \frac{(z-z_0)^{\rho_1 + \rho_2 -2} (R_1(z)\tilde{\tilde{R}}_2(z) - R_2(z)\tilde{\tilde{R}}_1(z))}{(z-z_0)^{\rho_1 + \rho_2 -1} (R_1(z)\tilde{R}_2(z) - R_2(z)\tilde{R}_1(z))} = \nonumber \\
	 	 ...
	 	 &= \frac{P(z)}{z-z_0} \spacer P(z) = \frac{R_1(z)\tilde{\tilde{R}}_2(z) - R_2(z)\tilde{\tilde{R}}_1(z)}{R_1(z)\tilde{R}_2(z) - R_2(z)\tilde{R}_1(z)}
\end{align}
