...
\begin{align}
	f(z_0) = \left. \frac{df(z)}{dz} \right|_{z=z_0} =  \left. \frac{d^2 f(z)}{dz^2} \right|_{z=z_0} = \dots = \left. \frac{d^{n-1}f(z)}{dz^{n-1}} \right|_{z=z_0} = 0 \\
